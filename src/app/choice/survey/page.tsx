...
const surveys: Record<string, Survey[]> = {
  ...
  가슴: [
    ...
    { id: 6, description: "팔을 앞으로 들었던 팔을 옆으로 벌릴 때 어깨의 운동 범위가 제한된다." },
  ...
  등: [
    ...
    { id: 10, description: "앉거나 서서 기대지 않고 몸을 바로 해서 체중 부하가 되면 통증이 극심하게 나타난다" }
  ],
  팔: [
  ...
  허리: [
      ...
      { id: 5, description: "지속적으로 통증이 나타난다. 통증은 움직임과 관계있고 음식을 먹거나 배변을 하는 것과는 상관이 없다" },
  ...
  골반: [
    ...
    { id: 6, description: "자유형으로 수영을 할 때 엉덩이 부위의 통증이 심해진다" },
  ...
  다리: [
    ...
    { id: 17, description: "수면 중 다리를 편하게 두기 어려워 아프지 않은 쪽으로 누워서 다리사이에 베개를 넣는다" },
  ...
  발목: [
    ...
    { id: 15, description: "불규칙한 바닥을 걸을 때나 달리면 발과 아킬레스건 주변이 아프다" },
    { id: 16, description: "소아시절에 과도한 육체적인 활동 후에 나타나는 성장통이 있었다" },
